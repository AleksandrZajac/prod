<main class="page-delivery">
  ...
  <section class="page-delivery__info">
    ...
    <ul class="page-delivery__list">
      <li>
        <b class="page-delivery__item-title">Стандартная доставка - <?=$standardDelivery['delivery_price']?> 
        РУБ / БЕСПЛАТНО (ДЛЯ ЗАКАЗОВ ОТ <?=$standardDelivery['order_sum']?> РУБ)</b>
        <p class="page-delivery__item-desc">
          Примерный срок доставки составит около 2-7 рабочих дней, в зависимости от адреса доставки.
        </p>
      </li>
      <li>
        <b class="page-delivery__item-title">В день покупки - <?=$onDayOfPurchase['delivery_price']?> 
        РУБ / БЕСПЛАТНО (ДЛЯ ЗАКАЗОВ ОТ <?=$onDayOfPurchase['order_sum']?>  РУБ)</b>
        <p class="page-delivery__item-desc">
      ...
      <li>
        <b class="page-delivery__item-title">Доставка с примеркой перед покупкой по Москве - <?=$deliveryWithFittingInMoskow['delivery_price']?> РУБ / 
        БЕСПЛАТНО (ПРИ ВЫКУПЕ НА СУММУ ОТ <?=$deliveryWithFittingInMoskow['order_sum']?> РУБ)</b>
        <p class="page-delivery__item-desc">
