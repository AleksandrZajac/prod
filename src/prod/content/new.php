  ...
  <section class="shop container">
    <section class="shop__filter filter">
      ...
      <div class="filter__wrapper">
        ...
        <?php foreach ($catergories as $key => $value): ?>
          <li>
            <a class="filter__list-item" href="/new/category/<?=$catergories[$key]['path']?>"><?=$catergories[$key]['name']?></a>
          </li>
          <?php endforeach;?>
        </ul>
      </div>
        <div class="filter__wrapper">
          ...
          <div class="filter__range range">
            ...
            <div class="range__res">
              ...
              <input type="hidden" class="max-price-value" name="max-price" data-attr="<?=$maxBasePrice?>" value="<?=maxPrice($maxBasePrice)?>">            </div>
          </div>
        </div>
    ...
    <div class="shop__wrapper">
      ...
      <?php for ($i = 1; $i < $options['total'] + 1; $i++): ?>
        ...
        <li>
          <a class="paginator__item" href="/new/?<?=path() . $i?>">
            <?=$i?>
          </a>
        </li>
        <?php endif;?>
