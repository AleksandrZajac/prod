<main class="page-order">
  ...
  <ul class="page-order__list" id="orders-list"></ul>
  <template id="order">
    <li class="order-item page-order__item">
      <div class="order-item__wrapper">
        ...
        <div class="order-item__group">
          ...
          <span class="order-item__info price-sum">10 400 руб.</span>    
        </div>
      ...
      <div class="order-item__wrapper">
        ...
        <div class="order-item__group order-item__group--status">
          ...
          <form id="change-order-status" method="post">
          <input id="order-id" type="hidden" name="order-id">
          <input id="order-status" type="hidden" name="order-status">
          <button type="submit" class="order-item__btn">Изменить</button>
          </form>
        </div>
      </div>
      <div class="order-item__wrapper">
