<main class="shop-page">
  ...
  <section class="shop container">
    <section class="shop__filter filter">
      ...
      <div class="filter__wrapper">
        ...
        <?php foreach ($catergories as $key => $value): ?>
          <li>
            <a class="filter__list-item" href="/sale/category/<?=$catergories[$key]['path']?>"><?=$catergories[$key]['name']?></a>
          </li>
          <?php endforeach;?>
        </ul>
      </div>
    ...
    <div class="shop__wrapper">   <div class="shop__wrapper">
    <section class="shop__sorting">
      ...
      <?php for ($i = 1; $i < $options['total'] + 1; $i++): ?>
        ...
        <li>
          <a class="paginator__item" href="/sale/?<?=path() . $i?>">
            <?=$i?>
          </a>
        </li>
        <?php endif;?>
